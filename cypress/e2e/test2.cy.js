...
describe('Переход на страницу входа/регистрации', () => {
  it('Нажимаем на кнопку Signup/Login', () => {
    ...
    cy.get('[data-qa = "signup-email"]').type('userTest12@mailsac.com')
...
describe('Переход на страницу входа/регистрации', () => {
  it('Нажимаем на кнопку Signup/Login', () => {
    ...
    cy.get('[data-qa = "login-email"]').type('userTest11@mailsac.com')
    cy.get('[data-qa= "login-password"]').type('1234567Q')
